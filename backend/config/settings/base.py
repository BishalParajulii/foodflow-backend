...
MIDDLEWARE = [
    ...
    # Serves /static/ (incl. Django admin CSS/JS) straight from gunicorn.
    # collectstatic already runs in docker-entrypoint.sh; without this,
    # DEBUG=False never serves static files (admin looks unstyled).
